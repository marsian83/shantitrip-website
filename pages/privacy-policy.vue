<template>
  ...
  <div class="p-page flex flex-col gap-6">
    <h1 class="font-bold text-6xl text-center">Privacy Policy</h1>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to ShantiTrip, 511, Main Manikaran Road, Suma
          Ropa, Kasol, District Kullu, Himachal Pradesh – 175105.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p><strong>Country</strong> refers to: Himachal Pradesh, India</p>
      </li>
      <li>
        <p>
