  ...
  <div class="p-page flex flex-col gap-6">
    ...
    <p>
      ...
      <a
        ...
        target="_blank"
        >TermsFeed Cookies Policy Generator</a
      >.
    </p>
    <p>
    ...
    <ul>
      <li>
        ...
        Policy) refers to ShantiTrip, 511, Main Manikaran Road, Suma Ropa,
        Kasol, District Kullu, Himachal Pradesh – 175105.
      </li>
      <li>
      ...
      <li>
        <strong>Website</strong> refers to ShantiTrip, accessible from
        <a
          href="https://www.shantitrip.com"
          rel="external nofollow noopener"
          target="_blank"
          >https://www.shantitrip.com</a
        >
      </li>
      <li>
    ...
    <ul>
      <li>
        <p>By email: info@shantitrip.com</p>
      </li>
      <li>
        <p>
          By visiting this page on our website:
          <a
            href="https://www.shantitrip.com/contact"
            rel="external nofollow noopener"
            target="_blank"
            >https://www.shantitrip.com/contact</a
          >
        </p>
      </li>
      <li>
        <p>By phone number: +919459668084</p>
      </li>
      <li>
        <p>
          By mail: 511, Main Manikaran Road, Suma Ropa, Kasol, District Kullu,
